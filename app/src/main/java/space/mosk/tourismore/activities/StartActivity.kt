...
import space.mosk.tourismore.adapters.ViewPagerStartAdapter
import space.mosk.tourismore.adapters.SliderStartItem
import java.util.*
...
class StartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mList.add(SliderStartItem("Travel", "Исследуй мир с новой стороны\n Поделись эмоциями с другими пользователями",
            R.drawable.service1
        ))
        mList.add(SliderStartItem("Communicate", "Найди новых друзей\n И стань самым популярным автором",
            R.drawable.service2
        ))
        mList.add(SliderStartItem("TouriseMore", "Сделай свое путешествие незабываемым вместе с TourisMore!",
            R.drawable.service3
        ))
